...
export interface DealerAgreementSignedProps {
  branding: Branding;
  customer_name: string;
  signed_date: string;
}

export const DealerAgreementSigned = ({
  branding,
  customer_name,
  signed_date,
}: DealerAgreementSignedProps) => {
  return (
    <Layout branding={branding} preview="Your Dealer Agreement has been fully executed">
      <Heading
      ...
      >
        Your Dealer Agreement has been fully executed. A signed copy is attached for your records.
      </Text>
...
export default function DealerAgreementSignedPreview() {
  return (
    <DealerAgreementSigned
      branding={{
